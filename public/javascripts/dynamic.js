    ...
    $('#submitButton').click(function(){
        ...
        $.post("predict", messageFraud, function(result){
            ...
            if (prediction < 25) {
                ...
                document.getElementsByName("someName")[0].innerText = "No Fraud Detected"
            } else if (prediction > 70) {
                document.getElementById('prugressBur').className = "progress is-danger is-large";
                document.getElementsByName("someName")[0].innerText = "Fraud Detected"
            } else {
                document.getElementById('prugressBur').className = "progress is-warning is-large";
                document.getElementsByName("someName")[0].innerText = "Potential Fraud"
            }
